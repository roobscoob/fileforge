...
> {
  ...
  ProviderError(UnderlyingProviderError<'pool, Re, Se, DIAGNOSTIC_NODE_NAME_SIZE>),
}

impl<'pool, Re: ProviderError, Se: ProviderError, const DIAGNOSTIC_NODE_NAME_SIZE: usize>
  Error<DIAGNOSTIC_NODE_NAME_SIZE> for GetHeaderError<'pool, Re, Se, DIAGNOSTIC_NODE_NAME_SIZE>
{
