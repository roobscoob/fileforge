use crate::provider::{error::{read_error::ReadError, write_error::WriteError}, out_of_bounds::SliceOutOfBoundsError, r#trait::Provider};

use super::fixed::FixedSliceProvider;
...
impl<'underlying_lifetime, UnderlyingProvider: Provider> Provider for DynamicSliceProvider<'underlying_lifetime, UnderlyingProvider> {
  ...
  fn slice_dyn<'x>(&'x mut self, offset: u64, size: u64) -> Result<DynamicSliceProvider<'x, Self::ReturnedProviderType>, SliceOutOfBoundsError> {
