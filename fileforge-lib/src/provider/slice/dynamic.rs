...
impl<'underlying, UnderlyingProvider: Provider> Provider for DynamicSliceProvider<'underlying, UnderlyingProvider> {
  ...
  fn slice_dyn<'x>(&'x self, offset: u64, size: u64) -> Result<DynamicSliceProvider<'x, Self::ReturnedProviderType>, SliceOutOfBoundsError> {
...
impl<'underlying, UnderlyingProvider: Provider> Provider for DynamicMutSliceProvider<'underlying, UnderlyingProvider> {
  type ReadError = UnderlyingProvider::ReadError;
  type ReturnedProviderType = UnderlyingProvider;
  type DynReturnedProviderType = UnderlyingProvider;
...
impl<'underlying, UnderlyingProvider: MutProvider> MutProvider for DynamicMutSliceProvider<'underlying, UnderlyingProvider> {
  ...
  fn slice_mut_dyn<'x>(&'x mut self, offset: u64, size: u64) -> Result<DynamicMutSliceProvider<'x, Self::ReturnedProviderType>, SliceOutOfBoundsError> {
    SliceOutOfBoundsError::assert_in_bounds(offset, size, self.size)?;
