...
pub trait Provider {
  ...
  type StaticSliceProvider<'l, const SIZE: usize>: Provider<Type = Self::Type>
  where
    Self: 'l;

  type DynamicSliceProvider<'l>: Provider<Type = Self::Type>
  where
    Self: 'l;
...
pub trait MutProvider: Provider {
  ...
  type StaticMutSliceProvider<'l, const SIZE: usize>: Provider<Type = Self::Type>
  where
    Self: 'l;

  type DynamicMutSliceProvider<'l>: Provider<Type = Self::Type>
  where
    Self: 'l;
