use crate::{error::Error, object::nintendo::byml::unmanaged::error::get_string_table::StringTableOutOfBounds, provider::r#trait::Provider, reader::error::underlying_provider_read::UnderlyingProviderReadError};
