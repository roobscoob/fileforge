use crate::{object::nintendo::byml::unmanaged::header::error::BymlHeaderError, reader::error::{out_of_bounds::ReadOutOfBoundsError, underlying_provider_read::UnderlyingProviderReadError}, provider::error::ProviderError, error::Error};
...
impl<'pool, Re: ProviderError, const DIAGNOSTIC_NODE_NAME_SIZE: usize> Error<DIAGNOSTIC_NODE_NAME_SIZE> for GetHeaderError<'pool, Re, DIAGNOSTIC_NODE_NAME_SIZE> {
