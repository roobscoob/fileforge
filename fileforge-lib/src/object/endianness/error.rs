...
pub struct EndiannessMarkerError<'pool, const DIAGNOSTIC_NODE_NAME_SIZE: usize, const ENDIANNESS_SIZE: usize> {
...
impl<'pool, const DIAGNOSTIC_NODE_NAME_SIZE: usize, const ENDIANNESS_SIZE: usize> Error<DIAGNOSTIC_NODE_NAME_SIZE> for EndiannessMarkerError<'pool, DIAGNOSTIC_NODE_NAME_SIZE, ENDIANNESS_SIZE> {
