...
impl CellTag for TransformationName {
  fn get_name(&self) -> &'static str {
    core::any::type_name::<TransformationName>()
  }

  fn get_ansi_color(&self, _: Grapheme, _: CellTagContext) -> &'static str { "\x1b[37m" }
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-transformation-name" }
...
impl CellTag for TransformationSeparator {
  fn get_name(&self) -> &'static str {
    core::any::type_name::<TransformationSeparator>()
  }

  fn get_ansi_color(&self, _: Grapheme, _: CellTagContext) -> &'static str { "\x1b[37m" }
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-transformation-separator" }
