...
impl CellTag for ReportErrorHeader {
  ...
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-report-error-header" }
  fn get_rgba_color(&self, _: Grapheme, _: CellTagContext) -> (u8, u8, u8, u8) { (224, 102, 102, 255) }
...
impl CellTag for ReportErrorText {
  ...
  fn get_ansi_color(&self, _: Grapheme, _: CellTagContext) -> &'static str { "\x1b[38;5;9m" }
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-report-error-text" }
  fn get_rgba_color(&self, _: Grapheme, _: CellTagContext) -> (u8, u8, u8, u8) { (224, 102, 102, 255) }
...
impl CellTag for ReportWarningHeader {
  ...
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-report-warning-header" }
  fn get_rgba_color(&self, _: Grapheme, _: CellTagContext) -> (u8, u8, u8, u8) { (241, 194, 50, 255) }
...
impl CellTag for ReportWarningText {
  ...
  fn get_ansi_color(&self, _: Grapheme, _: CellTagContext) -> &'static str { "\x1b[38;5;220m" }
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-report-warning-text" }
  fn get_rgba_color(&self, _: Grapheme, _: CellTagContext) -> (u8, u8, u8, u8) { (241, 194, 50, 255) }
...
impl CellTag for ReportInfoSymbol {
  ...
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-report-info-symbol" }
  fn get_rgba_color(&self, _: Grapheme, _: CellTagContext) -> (u8, u8, u8, u8) { (109, 158, 235, 255) }
...
impl CellTag for ReportInfoName {
  ...
  fn get_ansi_color(&self, _: Grapheme, _: CellTagContext) -> &'static str { "\x1b[38;5;75m" }
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-report-info-name" }
  fn get_rgba_color(&self, _: Grapheme, _: CellTagContext) -> (u8, u8, u8, u8) { (109, 158, 235, 255) }
...
impl CellTag for ReportInfoTypename {
  ...
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-report-info-typename" }
...
impl CellTag for ReportInfoTypenameCell {
  ...
  fn get_ansi_color(&self, _: Grapheme, _: CellTagContext) -> &'static str { "\x1b[38;5;240m" }
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-report-info-typename-cell" }
  fn get_rgba_color(&self, _: Grapheme, _: CellTagContext) -> (u8, u8, u8, u8) { (85, 85, 85, 255) }
...
impl CellTag for ReportInfoLineSymbol {
  ...
  fn get_ansi_color(&self, _: Grapheme, _: CellTagContext) -> &'static str { "\x1b[38;5;75m" }
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-report-info-line-symbol" }
  fn get_rgba_color(&self, _: Grapheme, _: CellTagContext) -> (u8, u8, u8, u8) { (109, 158, 235, 255) }
...
impl CellTag for ReportInfoLineText {
  ...
  fn get_ansi_color(&self, _: Grapheme, _: CellTagContext) -> &'static str { "\x1b[38;5;75m" }
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-report-info-line-text" }
  fn get_rgba_color(&self, _: Grapheme, _: CellTagContext) -> (u8, u8, u8, u8) { (109, 158, 235, 255) }
...
impl CellTag for ReportFlagLineSymbol {
  ...
  fn get_ansi_color(&self, _: Grapheme, _: CellTagContext) -> &'static str { "\x1b[38;5;220m" }
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-report-flag-line-symbol" }
  fn get_rgba_color(&self, _: Grapheme, _: CellTagContext) -> (u8, u8, u8, u8) { (241, 194, 50, 255) }
...
impl CellTag for ReportFlagLineText {
  ...
  fn get_ansi_color(&self, _: Grapheme, _: CellTagContext) -> &'static str { "\x1b[38;5;220m" }
  fn get_html_class_name(&self, _: Grapheme, _: CellTagContext) -> &'static str { "fileforge-lib-builtin-tag-report-flag-line-text" }
  fn get_rgba_color(&self, _: Grapheme, _: CellTagContext) -> (u8, u8, u8, u8) { (241, 194, 50, 255) }
